...
namespace Master.Finance
{
    ...
    {
        [InterColumn(ColumnName = "提交代理商", DisplayPath = "Unit.UnitName", Templet = "{{d.unitId_display||'/'}}", Sort = 1, EnableDataFilter = true)]
        ...
        [InterColumn(ColumnName = "经办人", DisplayPath = "CreatorUser.Name", Templet = "{{d.creatorUserId_display}}", Sort = 3, EnableDataFilter = true)]
        ...
        [InterColumn(ColumnName = "状态", ColumnType = Module.ColumnTypes.Select ,DictionaryName ="Master.Finance.VoucherStatus",Templet = "{{d.voucherStatus_display}}",Sort =5, EnableDataFilter = true)]
