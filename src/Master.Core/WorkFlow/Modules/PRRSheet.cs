...
{
    [InterModule("退货单查询", BaseType = typeof(FlowSheet), GenerateDefaultButtons = false, GenerateDefaultColumns = false)]
    public class PRRSheet: FlowSheet
    {
        ...
        [InterColumn(ColumnName = "退货时间", Sort = 3)]
        public override DateTime CreationTime { get => base.CreationTime; set => base.CreationTime = value; }
        [InterColumn(ColumnName = "经办人", DisplayPath = "CreatorUser.Name", Templet = "{{d.creatorUserId_display}}", Sort = 4)]
        public override long? CreatorUserId { get; set; }
        [InterColumn(ColumnName = "应收总额", ValuePath = "Property", ColumnType = Module.ColumnTypes.Number, Sort = 5)]
        [NotMapped]
