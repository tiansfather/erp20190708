...
{
    [InterModule("采购付款单", BaseType = typeof(FlowSheet), GenerateDefaultButtons = false)]
    public class PPYSheet : FlowSheet
    {
        ...
        [InterColumn(ColumnName = "收款供应商", DisplayPath = "Unit.UnitName", Templet = "{{d.unitId_display||'/'}}", Sort = 2, EnableDataFilter = true)]
        public override int? UnitId { get => base.UnitId; set => base.UnitId = value; }
        [InterColumn(ColumnName = "制单时间", ColumnType = Module.ColumnTypes.DateTime, Sort =3)]
        ...
        [InterColumn(ColumnName ="付款金额",ValuePath ="Property",ColumnType =Module.ColumnTypes.Number,Sort =5, DisplayFormat = "N2")]
        [NotMapped]
        public virtual decimal Fee{get;set;}
        [InterColumn(ColumnName = "付款类型", ValuePath = "Property",Sort =6, EnableDataFilter = true)]
        [NotMapped]
