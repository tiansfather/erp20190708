...
{
    [InterModule("销售收款单", BaseType = typeof(FlowSheet), GenerateDefaultButtons = false)]
    public class SSKSheet : FlowSheet
    {
        ...
        [InterColumn(ColumnName = "付款代理商", DisplayPath = "Unit.UnitName", Templet = "{{d.unitId_display||'/'}}", Sort = 2, EnableDataFilter = true)]
        ...
        [InterColumn(ColumnName ="收款金额",ValuePath ="Property",ColumnType =Module.ColumnTypes.Number,Sort =5, DisplayFormat = "N2")]
        [NotMapped]
        public virtual decimal Fee{get;set;}
        [InterColumn(ColumnName = "收款类型", ValuePath = "Property",Sort =6, EnableDataFilter = true)]
        [NotMapped]
