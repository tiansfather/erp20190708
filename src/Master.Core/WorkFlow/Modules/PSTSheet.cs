...
{
    [InterModule("过账单", BaseType = typeof(FlowSheet), GenerateDefaultButtons = false)]
    public class PSTSheet:FlowSheet
    {
        ...
        [InterColumn(ColumnName = "付款代理商", ValuePath = "Property", Sort = 2, EnableDataFilter = true)]
        [NotMapped]
        ...
        [InterColumn(ColumnName = "收款供应商", ValuePath = "Property", Sort = 6, EnableDataFilter = true)]
        [NotMapped]
        public virtual string InUnitName { get; set; }
        [InterColumn(ColumnName = "收款单位名称", ValuePath = "Property", Sort = 7, EnableDataFilter = true)]
        [NotMapped]
