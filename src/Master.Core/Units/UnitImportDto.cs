...
{
    [AutoMap(typeof(Unit))]
    public class UnitImportDto:IImport
    {
        [DisplayName("名称")]
        ...
        [ImportField(DictionaryName = "{\"1\":\"客户\",\"2\":\"供应商\",\"3\":\"客户及供应商\"}",Required =true)]
        public virtual UnitNature UnitNature { get; set; }
        [DisplayName("供应类别")]
        [ImportField(DictionaryName = StaticDictionaryNames.SupplierType,Required =true)]
