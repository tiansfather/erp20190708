...
config.ready = function () {
    ...
    layui.use([ 'formSelects'], function () {
        ...
        function useFunction(app) {
            ...
            var aPersonslt = ['tryPerson', 'tryColor', 'tryMaterial']//'poster',,'tryMaterial'
                ...
                app.oVariable.projectArr.forEach(function (n) {
                    ...
                    if (n.projectSN == valsD) {
                        ...
                        abp.services.app.processTask.getProjectChargerByProjectId(n.id).done(function (data) {
                            ...
                            app.currentItem.tryPerson = data || '';//是否要设默认空值

                            formSelects.value('tryPerson', [app.currentItem.tryPerson]); 
        ...
        //});    projectCharger: '', unitName: '',tryTimes: 0, tryMaterialId:0,material: '', materialBack: '',
        app = new Vue({
            el: '#app',
            data: {
                currentItem: {
                     mouldTrySN:'',id:0,memo: '', unitName: '', tryColor: '', tryNumber: 1, ifDry: false, poster: '', tryPerson: '', tn: -1, planDate: '', arrangeDate: '', actualDate: '', tryHours: '', tryMaterial: '', tryMachine: '', feeMachine: 0, feeMaterial: 0, feeOther:0,  materialOut_New: 0, materialOut_Old: 0, materialReturn_New: 0, materialReturn_New: 0, materialReturn_Old: 0, projectSN: '', materialOut_Old: 0, materialUsed_New: 0, materialUsed_Old: 0, coolingWater: '', wkRequire: '', toDemould:''
                },
                oVariable: { partArr: [], projectArr: [], projectId: '', partId: '' },
                materialInfo: {
                    ColumnKey: 'tryMaterialId',
                    ReferenceSearchWhere: { where: "1=1" },
                    placeholder: '',
                    SearchPlaceholder: '选择物料',
                    RelativeDataType: 'Module',
                    RelativeDataString: 'Material',
                    ReferenceItemTpl: 'name',
                    ReferenceSearchColumns: "name,specification,brand,price,measureMentId",
                },
                materialItem: {
                    value: 'id',
                    data: ''
            ...
            watch: {
                ...
                'currentItem.tn': function (newVal, val) {
                    if (formSelects.value('tn', 'val')[0] != app.currentItem.tn) {
                        //var a = [app.currentItem.tn.toString()];
                        formSelects.value('tn', [app.currentItem.tn.toString()]);
                    }
                },
            ...
            methods: {
                ...
                materialChoose: function (obj) {
                    console.log("zz"+obj)
                    this.currentItem.tryMaterialId = obj.value;
                    //this.currentItem.unitName = obj.displayValue;
                },
