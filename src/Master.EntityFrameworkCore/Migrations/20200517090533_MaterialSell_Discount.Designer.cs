...
namespace Master.Migrations
{
    ...
    [Migration("20200517090533_MaterialSell_Discount")]
    partial class MaterialSell_Discount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master.Finance.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("BuyUnitAddress");

                    b.Property<string>("BuyUnitBank");

                    b.Property<string>("BuyUnitBankAccount");

                    b.Property<string>("BuyUnitName");

                    b.Property<string>("BuyUnitPhone");

                    b.Property<string>("BuyUnitTaxNumber");
            ...
            modelBuilder.Entity("Master.Storage.MaterialBuyBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("MaterialBuyBack");
                });

            modelBuilder.Entity("Master.Storage.MaterialBuyCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<decimal?>("CodeEndNumber");

                    b.Property<decimal?>("CodeStartNumber");

                    b.Property<DateTime>("CreationTime");

                    b.Property<long?>("CreatorUserId");

                    b.Property<int>("MaterialBuyId");

                    b.HasKey("Id");

                    b.HasIndex("MaterialBuyId");

                    b.ToTable("MaterialBuyCode");
                });
            ...
            modelBuilder.Entity("Master.Storage.MaterialSellBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Master.Storage.MaterialSellOut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Master.Storage.MaterialBuyCode", b =>
                {
                    b.HasOne("Master.Storage.MaterialBuy", "MaterialBuy")
                        .WithMany("MaterialBuyCodes")
                        .HasForeignKey("MaterialBuyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
