...
{
    [AbpAuthorize]
    public class MaterialSellBackAppService:MasterAppServiceBase<MaterialSellBack,int>
    {
        public BaseTreeManager BaseTreeManager { get; set; }
        protected override async Task<IQueryable<MaterialSellBack>> GetQueryable(RequestPageDto request)
        {
        ...
        protected override object PageResultConverter(MaterialSellBack entity)
        {
            return new
            {
